    ...
    <div className={container}>
      <div className={card}>
        <div className={header}>
          <h1
            className='text-gray-600 font-bold text-3xl'>Welcome to <span
              className='text-violet-500'>FluxChat</span>
          </h1>
        </div>
        <form
        ...
        >
          ...
          <div className={passwordWrapper}>
            ...
            />
            <span
              className='absolute top-2.5 right-4 text-[#20c7ff] font-semibold cursor-pointer'
          ...
          <p
            ...
            Already Have An Account ? <span
              className='text-[#20c7ff] font-bold'>Login
            </span>
          </p>
        </form>
      </div>
